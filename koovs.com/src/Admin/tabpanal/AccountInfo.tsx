...
const AccountInfo = () => {
  ...
  const handleSetData = (name:string, email:string, pass:string, image:string, phone:string) => {
    setName(name)
    setEmailId(email)
    setPhone(phone)
    setPass(pass)
  ...
  const handleSendUpdatedData = () => {
    ...
    dispatch(getAdminPatch(Name,EmailId,Phone,Password,Image)).then((res:any)=>{
