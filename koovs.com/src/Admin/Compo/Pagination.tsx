  ...
  return (
    <Box p='10px'>
        <Flex justifyContent={'center'} columnGap='10px' >
            <Button isDisabled={page===1} onClick={()=>{setPage(page-1)}} colorScheme='teal' variant='outline'  >
            Prev
            </Button>
            <Heading size='lg' >{page}</Heading>
            <Button isDisabled={page===3} onClick={()=>{setPage(page+1)}} colorScheme='teal' variant='outline' >
                Next
            </Button>
