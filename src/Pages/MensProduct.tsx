    ...
    <>
                ...
                <Menu>
                  ...
                  <MenuList bg="orange">
                    ...
                    >
                      ...
                      <MenuItem>
                        <Checkbox value="Garcon">Garcon (7)</Checkbox>
                      </MenuItem>
                      <MenuItem>
                        <Checkbox value="The Couture Club">
                          The Couture Club (10)
                        </Checkbox>
                      </MenuItem>
                      <MenuItem>
                      ...
                      <MenuItem>
                        <Checkbox value="Essentials By Koovs">
                          Essentials By Koovs (12)
                        </Checkbox>
                      </MenuItem>
                    </CheckboxGroup>
                  </MenuList>
      ...
      <Center>
        ...
        <Button
          ...
          isDisabled={menProducts.length !== 12}
          colorScheme="black"
          variant="outline"
        >
          Next
